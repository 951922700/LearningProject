...
@ApiModel(value = "用户注册",description = "这是用户对象")
public class UsersVo {
     ...
     * name字段名字
     */
    @ApiModelProperty(value = "用户名",name = "username",example = "951922700",required =true )
    private String username;

    /**
     * 密码  @JsonIgnore不返回该参数
     */
    @ApiModelProperty(value = "密码",name = "password",example = "943033940",required =true)
    @JsonIgnore
